...
public class soal15 extends AppCompatActivity {
    private EditText edtsoal;
    private Button btnlihat, btnkembali;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnkembali.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(soal15.this, soal14.class);
        ...
        btnlihat.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (edtsoal.getText().toString().equals("")) {
                    Toast.makeText(soal15.this, "ISI DAHULU JAWABANNYA", Toast.LENGTH_SHORT).show();
                } else if (edtsoal.getText().toString().equals("NOVI MENONTON TELEVISI") || edtsoal.getText().toString().equals("novi menonton televisi")) {
   ...
   /* @Override
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_soal15, menu);
        return true;
    }
