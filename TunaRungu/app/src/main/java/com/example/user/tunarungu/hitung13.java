...
public class hitung13 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hitung13);
        getSupportActionBar().setTitle("Soal Ketigabelas");
        ...
        btnlanjut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(hitung13.this, hitung14.class);
        ...
        btnkembali.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(hitung13.this, hitung12.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        btnlihat.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (edtsoal.getText().toString().equals("")) {
                    Toast.makeText(hitung13.this, "ISI DAHULU JAWABANNYA", Toast.LENGTH_SHORT).show();
                } else if (edtsoal.getText().toString().equals("45")) {
    ...
    private void kali() {
        Intent i = new Intent(hitung13.this, perkalian.class);
        startActivity(i);
