    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnlanjut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(soal10.this, soal11.class);
        ...
        btnkembali.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(soal10.this, soal9.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        btnlihat.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (edtsoal.getText().toString().equals("")) {
                    Toast.makeText(soal10.this, "ISI DAHULU JAWABANNYA", Toast.LENGTH_SHORT).show();
                } else if (edtsoal.getText().toString().equals("RUDI BERMAIN BOLA") || edtsoal.getText().toString().equals("rudi bermain bola")) {
