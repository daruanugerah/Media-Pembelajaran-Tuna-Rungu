...
public class hitung9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hitung9);
        getSupportActionBar().setTitle("Soal Kesembilan");
        ...
        btnlanjut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(hitung9.this, hitung10.class);
        ...
        btnkembali.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(hitung9.this, hitung8.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        btnlihat.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (edtsoal.getText().toString().equals("")) {
                    Toast.makeText(hitung9.this, "ISI DAHULU JAWABANNYA", Toast.LENGTH_SHORT).show();
                } else if (edtsoal.getText().toString().equals("42")) {
    ...
    private void kali() {
        Intent i = new Intent(hitung9.this, perkalian.class);
        startActivity(i);
