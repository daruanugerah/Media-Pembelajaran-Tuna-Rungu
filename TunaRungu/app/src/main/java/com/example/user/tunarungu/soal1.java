...
public class soal1 extends AppCompatActivity {
    ...
    private Button btnlihat, btnlanjut;
        ...
        btnlihat.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (edtsoal.getText().toString().equals("")) {
                    Toast.makeText(soal1.this, "ISI DAHULU JAWABANNYA", Toast.LENGTH_SHORT).show();
                }
                else if (edtsoal.getText().toString().equals("ANDI MENCUCI BAJU") || edtsoal.getText().toString().equals("andi mencuci baju")) {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_soal1, menu);
        return true;
    }
