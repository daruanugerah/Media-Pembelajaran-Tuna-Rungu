...
public class hitung10 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hitung10);
        getSupportActionBar().setTitle("Soal Kesepuluh");
        ...
        btnlanjut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(hitung10.this, hitung11.class);
        ...
        btnkembali.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(hitung10.this, hitung9.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        btnlihat.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (edtsoal.getText().toString().equals("")) {
                    Toast.makeText(hitung10.this, "ISI DAHULU JAWABANNYA", Toast.LENGTH_SHORT).show();
                } else if (edtsoal.getText().toString().equals("32")) {
    ...
    private void kali() {
        Intent i = new Intent(hitung10.this, perkalian.class);
        startActivity(i);
